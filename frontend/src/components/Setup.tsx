    ...
    <section id="setup" className="py-20">
      <div className="mx-auto max-w-[1400px] px-8">
        <div className="mb-10 text-center">
          <div className="mb-3 text-xs font-semibold uppercase tracking-wider text-[#A1A1AA]">
            SETUP
          </div>
          <h2 className="text-3xl font-bold tracking-tight text-white md:text-4xl">Connect in 3 steps</h2>
          <p className="mt-3 text-[#A1A1AA]">Works with every major AI platform</p>
        </div>
        ...
        <motion.div
          ...
          className="mx-auto max-w-2xl rounded-xl border border-white/[0.06] bg-[#111113] p-8"
        >
          {/* Steps */}
            ...
            <div className="mt-4 flex flex-col gap-2">
              {data.urls.map((url) => (
                <div key={url.label} className="rounded-lg bg-black/30 px-4 py-3">
                  <div className="mb-1 text-xs text-[#A1A1AA]">{url.label}</div>
          ...
          {/* Note */}
          {data.note && (
            <p className="mt-4 text-xs text-[#A1A1AA]">{data.note}</p>
          )}
        </motion.div>
      </div>
    </section>
