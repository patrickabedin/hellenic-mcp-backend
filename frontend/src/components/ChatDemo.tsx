...
export default function ChatDemo() {
  ...
  return (
    <div className="w-full rounded-xl border border-white/[0.06] bg-[#111111] overflow-hidden">
      {/* Header */}
      <div className="flex items-center gap-2 border-b border-white/[0.06] bg-[#3B82F6]/8 px-5 py-3.5">
        ...
        {messages.map((msg, i) => (
          ...
          >
            {msg.type === 'user' ? (
              ...
              <>
                <div className="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-lg bg-[#3B82F6]/20 text-xs font-semibold text-[#3B82F6]">
                  AI
                </div>
                <div
                  className={`rounded-lg border bg-white/[0.02] px-4 py-3 text-sm leading-relaxed text-white/80 ${
                    msg.isTyping && showCursor ? 'border-[#3B82F6]/30 typewriter-cursor' : 'border-white/[0.06]'
                  }`}
      ...
      <div className="flex items-center gap-3 border-t border-white/[0.06] bg-[#0a0a0c] px-4 py-3.5">
        <input
          ...
          readOnly
          className="flex-1 rounded-lg border border-white/[0.06] bg-[#18181b] px-4 py-2.5 text-sm text-white/80 placeholder-white/30 outline-none focus:border-[#3B82F6]/50 transition-colors"
        />
        <button
          className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-lg bg-[#3B82F6] text-white transition-colors hover:bg-[#2563EB]"
          aria-label="Send"
        >
